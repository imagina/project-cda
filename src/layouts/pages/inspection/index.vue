					...
					<div class="row">
							...
							<q-timeline  color="black" :responsive="false" class="border-bottom-none">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<q-select
												...
												class="bg-white q-py-sm q-my-md"></q-select>
										</div>
									</div>
								...
								<q-timeline-entry
									...
									<div class="border-bottom">
										<router-link
											:to="{name: 'update.inspection',params: {inspection: item.id}}"
											class="link row">
											...
											<div class="col px-2">
												...
												Cliente : <b>{{ order.vehicle.user.fullname | uppercase }}</b>
						...
						<div class="col-12 d-block q-py-md">
							<div v-infinite-scroll="loadMore"
								 :infinite-scroll-disabled="$store.getters['inspections/GET_PAGE_BUSY']"
