                                ...
                                <div class="row">
                                    <div class="col-12 q-px-md">
                                        ...
                                        <div class="d-inline-block">
                                            ...
                                            <q-radio v-model="data.vehicle_gas" :val="false" label="No" class="q-mr-lg"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" v-show="data.vehicle_gas">
...
<script>
    ...
    export default {
        name: 'PageData',
        components: { qInputValidation, qGallery, qInventary, qAxes, qContract, VueSignaturePad},
        data () {
            return {
                show: false,
                showData: false,
