        ...
        <div class="row">
          <div class="col-12 col-sm-10 col-md-6 mx-auto q-px-md">
            ...
            <div class="w-50 d-inline-block">
              <q-select
                readonly v-model="data.inspections_types_id"
                :options="$store.state.data.types_inspections"
          ...
          <div class="container-fluid bg-gray-10">
            ...
            <div class="row print-row align-items-center">
              ...
              <div class="col-4 col-md-2 mx-auto py-3 text-center print-col-3 print-center">
                <p class="font-weight-bold font-family">
                  <b>Expedición</b>
                </p>
                <p class="mb-0">
                  <q-datetime
                    v-model.trim="data.attributes.insurance_expiration"
              ...
              <div class="col-4 col-md-2 mx-auto py-3 text-center">
                <p class="font-weight-bold font-famili">
                  <b>ESTADO</b>
                </p>
                <p
                  class="mb-0 text-uppercase"
                  :class="{'text-green': validity(data.attributes.insurance_expiration),
                  'text-red': !validity(data.attributes.insurance_expiration)}">
              ...
              <div class="col-12 col-md-3 px-2 py-3 bg-primary text-right print-none flex flex-center">
                <span class="h2 font-weight-bold my-3 d-block text-white">
                ...
                <div class="col-12 col-md-6 q-px-md">
                  ...
                  <q-field :error="$v.data.attributes.service_type.$error">
                    <span
                      ...
                      :class="{'color-danger': $v.data.attributes.service_type.$error}">
                      Tipo de Servicio:
                    </span>
                    <q-select
                      :disable='!isUpdate'
                      v-model="data.attributes.service_type"
                  ...
                  <q-field :error="$v.data.attributes.type_vehicle.$error">
                    <span
                      class="font-weight-bold d-inline-block"
                      :class="{'color-danger': $v.data.attributes.type_vehicle.$error}">
                      Clase de Vehículo
                    </span>
                    <q-select
                      :disable='!isUpdate'
                      v-model="data.attributes.type_vehicle"
                      class="q-mb-lg uppercase"
